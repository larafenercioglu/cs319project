...
public class InstructorAndTAs implements User {
    ...
    */
     ...
     */
    public Announcement announce(String title, Class aClass, List<Group> groups){
        Announcement announcement = new Announcement(title, this.userName + " " + this.userSurname);
