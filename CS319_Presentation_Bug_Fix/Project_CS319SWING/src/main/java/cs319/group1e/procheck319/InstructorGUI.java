...
//////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addAnnouncementToAGroupActionPerformed(evt);
            }
        });
        ...
        jLabel53.setText("Enter Announcement:");

        jLabel65.setText("Current Announcements");
                ...
                calendarPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(calendarPanelLayout.createSequentialGroup()
                                .addGroup(calendarPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(calendarPanelLayout.createSequentialGroup()
                                                .addContainerGap()
                                                .addComponent(jLabel24, javax.swing.GroupLayout.DEFAULT_SIZE, 724, Short.MAX_VALUE))
                                        .addGroup(calendarPanelLayout.createSequentialGroup()
                                                .addGap(21, 21, 21)
                                                .addGroup(calendarPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void generateRandomGroupsActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        System.out.println("abcabca TEST FOR HASH: " + studentsGroupsMap);
        System.out.println("Geliyom");
        System.out.println(studentsGroupsMap);
    ...
    private void addAnnouncementActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Class c = classRepository.findByClassId(319);
        //Announcement a = new Announcement(announcement,currentUser.getUserName());
        currentUser.announce(announcement,c,groupRepository.findAll());
        //c.addAnnouncement(a);
        /*for(int i = 0; i < c.getGroupIdList().size(); i++){
            Group g = groupRepository.findByGroupId(c.getGroupIdList().get(i));
            g.addAnnouncement(a);
            groupRepository.save(g);
        }*/
        groupRepository.saveAll(groupRepository.findAll());
        classRepository.save(c);
        String announcements = "";
        for(int i = 0; i < c.getAnnouncementList().size(); i++){
            announcements += "\nAnnouncement " +( i + 1) + ": "  + c.getAnnouncementList().get(i);
        }
        jTextArea2.setText(announcements);
    }
    private void addAnnouncementToAGroupActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
